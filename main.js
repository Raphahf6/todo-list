                ...
                axios.get(urlTodo)
                    .then(response => {
                        ...
                        for (j = 0; j < todo.length; j++) {
                            ...
                            divTarefas.innerHTML += `<div class="container col-xl-12" id="mensagem-${id}"><ul class="list-group form-inline col-xl-12 col-md-12 col-sm-12 col-lg-12">
                                                             <li class="mensagem-${id} list-group-item form-inline col-xl-12 col-md-12 col-sm-12 col-lg-12 bg-transparent" id="tarefas" style="border-style:none;">
                        ...
                        btnAddTarefa.addEventListener('click', () => {
                            divTarefas.innerHTML += `<div class="container col-xl-12 col-md-12 col-sm-12 col-lg-12"><ul class="list-group form-inline col-xl-12">
                                                     <li class="list-group-item form-inline col-xl-12 col-md-12 col-sm-12 col-lg-12 bg-transparent" id="tarefas" style="border-style:none;">
